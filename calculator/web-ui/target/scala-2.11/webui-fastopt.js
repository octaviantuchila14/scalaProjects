...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var res = $as_sci_Map($s_sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(namedExpressions, f, bf));
  return res
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    var x = ("Expression: " + expr.toString__T());
    var this$2 = $m_s_Console$();
    var this$3 = this$2.outVar$2;
    $as_Ljava_io_PrintStream(this$3.tl$1.get__O()).println__O__V(x);
    var this$4 = references;
    var x$1 = ("References: " + $s_sc_TraversableLike$class__toString__sc_TraversableLike__T(this$4));
    var this$6 = $m_s_Console$();
    var this$7 = this$6.outVar$2;
    $as_Ljava_io_PrintStream(this$7.tl$1.get__O()).println__O__V(x$1);
    var this$8 = references;
    var this$9 = new $c_sc_MapLike$DefaultValuesIterable().init___sc_MapLike(this$8);
    var this$10 = this$9.$$outer$f;
    var this$11 = new $c_sc_MapLike$$anon$2().init___sc_MapLike(this$10);
    while (this$11.iter$2.hasNext__Z()) {
      var arg1 = this$11.next__O();
      var x$2 = $as_Lcalculator_Signal(arg1);
      var x$3 = x$2.apply__O();
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var this$15 = references;
      var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x3$1) {
        return (function(x$2$2) {
          var x$2$1 = $as_T(x$2$2);
          return (x$2$1 !== x3$1.name$2)
        })
      })(x3));
      var temp$references = new $c_sci_MapLike$$anon$1().init___sci_MapLike__F1(this$15, p);
      expr = temp$expr;
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().chooseColour__Lcalculator_Signal__T(remainingCharsCount$1)
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.chooseColour__Lcalculator_Signal__T = (function(remainingCharsCount) {
  if (($uI(remainingCharsCount.apply__O()) >= 15)) {
    return "green"
  } else if (($uI(remainingCharsCount.apply__O()) >= 0)) {
    return "orange"
  } else {
    return "red"
  }
...
$c_Lcalculator_Calculator$$anonfun$1.prototype.apply__T2__T2 = (function(namedEx) {
  var $$this = namedEx.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr = new $c_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1().init___Lcalculator_Calculator$$anonfun$1__T2(this, namedEx);
...
/** @constructor */
var $c_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1 = (function() {
  $c_sr_AbstractFunction0$mcD$sp.call(this);
  this.$$outer$3 = null;
  this.namedEx$1$f = null
});
$c_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1.prototype = new $h_sr_AbstractFunction0$mcD$sp();
$c_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1.prototype.constructor = $c_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1;
/** @constructor */
var $h_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1 = (function() {
  /*<skip>*/
});
$h_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1.prototype = $c_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1.prototype;
$c_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1.prototype.apply$mcD$sp__D = (function() {
  var jsx$2 = $m_Lcalculator_Calculator$();
  var jsx$1 = $as_Lcalculator_Expr($as_Lcalculator_Signal(this.namedEx$1$f.$$und2$f).apply__O());
  var this$1 = this.$$outer$3.namedExpressions$1$f;
  var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
    return (function(x$1$2) {
      var x$1 = $as_T(x$1$2);
      return (x$1 !== arg$outer.namedEx$1$f.$$und1$f)
    })
  })(this));
  return jsx$2.eval__Lcalculator_Expr__sci_Map__D(jsx$1, new $c_sci_MapLike$$anon$1().init___sci_MapLike__F1(this$1, p))
});
$c_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1.prototype.init___Lcalculator_Calculator$$anonfun$1__T2 = (function($$outer, namedEx$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
  };
  this.namedEx$1$f = namedEx$1;
  return this
});
$c_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1.prototype.apply__O = (function() {
  return this.apply$mcD$sp__D()
});
var $d_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1 = new $ClassTypeData({
  Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1: 0
}, false, "calculator.Calculator$$anonfun$1$$anonfun$apply$1", {
  Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1: 1,
...
$c_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1.prototype.$classData = $d_Lcalculator_Calculator$$anonfun$1$$anonfun$apply$1;
/** @constructor */
...
$c_sci_MapLike$$anon$1.prototype.seq__sc_Iterable = (function() {
  return this
});
